...
plot(x,l,type='l', xlab='p', ylab='score',ylim=c(0,5))
#abline(h=0)
#lines(x,l2,col='green')
#lines(x,l4,col='red')
lines(x,l5,col='red')
#lines(x,l5,col='purple') 
legend(.5,3.5,c('Kaggle Loss','Proposed Loss'), lty=c(1,1), lwd=c(2.5,2.5),col=c("red",'black'))
dev.off()
...
lines(x,l5,lty=2)
#lines(x,l5,col='purple') 
legend(.5,3.5,c('Kaggle Loss','Proposed Loss'), lty=c(2,1), lwd=c(2.5,2.5))
dev.off()
